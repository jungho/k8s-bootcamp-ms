  ...
  render() {
    ...
    return (
      <div className="login-container">
          <div className="login">
            <div className="panel">
              <div className="panel-heading text-center"><h2>Login Todo</h2><h6> Version: Green </h6></div>
              <div className="panel-body">
                <div className="col-xs-12 text-center">
                  <button className="btn btn-success" type="button" onClick={() => {this.ADLogin();}}>
                ...
                </div>
                {
                  TEST_MODE ?
                    <form className="form-horizontal col-xs-12 test-mode-form" onSubmit={this.onFormSubmit}>
                      ...
                      <div className="form-group">
                        <button type="submit" className="btn btn-success">Submit <i className="fa fa-sign-in"/></button>
                      </div>
                    </form>
                    : ''
                }
